...
const rolePermissions: Record<string, string[]> = {
  ...
  [ROLE_CODES.ADMINISTRATOR]: [
    ...
    PERMISSIONS.FACILITY_BOOKING_VIEW,
    PERMISSIONS.FACILITY_BOOKING_APPROVE,
    PERMISSIONS.FACILITY_BOOKING_MANAGE,
    PERMISSIONS.RESIDENT_REQUEST_VIEW,
    PERMISSIONS.RESIDENT_REQUEST_REVIEW,
    PERMISSIONS.RESIDENT_REQUEST_APPROVE,
    PERMISSIONS.RESIDENT_REQUEST_ISSUE,
    PERMISSIONS.RESIDENT_REQUEST_MANAGE,
    PERMISSIONS.MOVE_IN_VIEW,
    PERMISSIONS.MOVE_IN_MANAGE,
    PERMISSIONS.MOVE_IN_APPROVE,
    PERMISSIONS.MOVE_OUT_VIEW,
    PERMISSIONS.MOVE_OUT_MANAGE,
    PERMISSIONS.MOVE_OUT_APPROVE,
    PERMISSIONS.COMMUNITY_EVENT_VIEW,
    PERMISSIONS.COMMUNITY_EVENT_MANAGE,
  ...
  [ROLE_CODES.SECURITY_GUARD]: [
    ...
    PERMISSIONS.DELIVERY_COLLECT,
    PERMISSIONS.DELIVERY_RETURN,
    PERMISSIONS.VEHICLE_VERIFY,
  ],
};
