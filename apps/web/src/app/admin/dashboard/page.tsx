      ...
      <section aria-labelledby="attention-required" className="mt-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {Number(data.outstandingDues) > 0 && (
            <Link
              href="/admin/dues"
              className="block rounded-xl border border-orange-200 bg-orange-50 p-4 hover:bg-orange-100 transition-colors"
            >
              <p className="text-sm font-medium text-orange-800">
                Outstanding Dues
              </p>
              <p className="mt-1 text-2xl font-bold text-orange-950">
                {money(data.outstandingDues)}
              </p>
            </Link>
          )}
          {Number(data.openComplaints) > 0 && (
            <Link
              href="/admin/complaints"
              className="block rounded-xl border border-red-200 bg-red-50 p-4 hover:bg-red-100 transition-colors"
            >
          ...
          {Number(data.failedDeliveries) > 0 && (
            <Link
              ...
              className="block rounded-xl border border-rose-200 bg-rose-50 p-4 hover:bg-rose-100 transition-colors"
            >
          ...
          Number(data.failedDeliveries) === 0 && (
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              <p className="text-sm font-medium text-emerald-800">
                All caught up! No critical items require your immediate
                attention.
              </p>
            </div>
          )}
